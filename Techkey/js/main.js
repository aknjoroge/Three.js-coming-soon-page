...
$(document).ready(function ($) {
  ...
  // });
  $(".ts-open-side-panel").on("click", function () {
    $(".ts-side-panel").toggleClass("hidden");
  });
        ...
        el.empty()
          ...
          .append(
            "<div><span class='ts-cc-number'>" +
              ...
              " </span><span class='ts-cc-description'>Hrs_</span></div>"
          )
          .append(
            "<div><span class='ts-cc-number'>" +
              this.leadingZeros(data.min, 2) +
              " </span><span class='ts-cc-description'>Min_</span></div>"
          )
          .append(
            "<div><span class='ts-cc-number'>" +
              this.leadingZeros(data.sec, 2) +
              " </span><span class='ts-cc-description'>Sec_</span></div>"
          );
      },
    });
  });
